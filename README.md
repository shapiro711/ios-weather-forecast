...
<div markdown="1">
 ...
 `Any`타입으로 타입캐스팅을 하여 `nil`이 담긴 변수를 이용할 수는 있지만, 그렇게 하기보다 `Any?`로 명시적 사용을 해주는 것이 좋을 것 같다. (사용하는 입장에서 `nil`이 담겨있을 수도 있다는 것을 알 수 있으므로)
...
- `UIAlertAction`의 `completion closure`에서 `UIAlertController`를 약한참조 하도록 함으로써 해결하였다.
...
<img width="300" alt="스크린샷 2021-10-22 오후 8 53 23" src="https://user-images.githubusercontent.com/39452092/138450572-647ba207-463c-4648-b1d8-2d63f32975ed.png">
...
<img width="300" alt="스크린샷 2021-10-22 오후 8 53 23" src="https://user-images.githubusercontent.com/39452092/138450413-ae9923dc-e9e2-457c-a258-5bc9969cee33.png">
...
&nbsp;   
  ...
  <img width="300" alt="스크린샷 2021-10-22 오후 8 53 23" src="https://user-images.githubusercontent.com/39452092/138450006-d7d40d60-8d36-4c08-b536-4ef7186c32a7.png"> </div> </details>

  <details> <summary> <b> 새로고침 이후 </b>  </summary> <div markdown="1">

  <img width="300" alt="스크린샷 2021-10-22 오후 8 53 23" src="https://user-images.githubusercontent.com/39452092/138450071-9317b876-e3af-4268-9f29-a5f2c06a9a0e.png"> </div> </details>
...
<details> <summary> <b> 에러 코드 </b>  </summary> <div markdown="1">
